...
/// </para>
/// </remarks>
public readonly record struct ResultSlotId : IComparable<ResultSlotId>, IComparable
{
    ...
    /// otherwise <see langword="false"/>.
    /// </returns>
    public static bool operator <(ResultSlotId left, ResultSlotId right) => left.CompareTo(right) < 0;
    ...
    /// </remarks>
    public int CompareTo(ResultSlotId other) => string.CompareOrdinal(_value, other._value);
    ...
    /// </returns>
    /// <exception cref="ArgumentException"><paramref name="obj"/> is not a <see cref="ResultSlotId"/>.</exception>
    /// <remarks>
    ...
    /// <see cref="CompareTo(ResultSlotId)"/> instead and box nothing.
    /// </remarks>
    int IComparable.CompareTo(object? obj) => obj switch
    {
        null => 1,
        ResultSlotId other => CompareTo(other),
        _ => throw new ArgumentException($"The argument must be a {nameof(ResultSlotId)}.", nameof(obj)),
    };
