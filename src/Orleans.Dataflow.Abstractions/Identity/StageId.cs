...
/// </para>
/// </remarks>
public readonly record struct StageId : IComparable<StageId>, IComparable
{
    ...
    /// otherwise <see langword="false"/>.
    /// </returns>
    public static bool operator <(StageId left, StageId right) => left.CompareTo(right) < 0;
    ...
    /// </remarks>
    public int CompareTo(StageId other) => string.CompareOrdinal(_value, other._value);
    ...
    /// </returns>
    /// <exception cref="ArgumentException"><paramref name="obj"/> is not a <see cref="StageId"/>.</exception>
    /// <remarks>
    ...
    /// <see cref="CompareTo(StageId)"/> instead and box nothing.
    /// </remarks>
    int IComparable.CompareTo(object? obj) => obj switch
    {
        null => 1,
        StageId other => CompareTo(other),
        _ => throw new ArgumentException($"The argument must be a {nameof(StageId)}.", nameof(obj)),
    };
