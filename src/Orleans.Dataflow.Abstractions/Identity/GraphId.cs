...
/// </para>
/// </remarks>
public readonly record struct GraphId : IComparable<GraphId>, IComparable
{
    ...
    /// </remarks>
    public int CompareTo(GraphId other) => string.CompareOrdinal(_value, other._value);
    ...
    /// </returns>
    /// <exception cref="ArgumentException"><paramref name="obj"/> is not a <see cref="GraphId"/>.</exception>
    /// <remarks>
    ...
    /// <see cref="CompareTo(GraphId)"/> instead and box nothing.
    /// </remarks>
    int IComparable.CompareTo(object? obj) => obj switch
    {
        null => 1,
        GraphId other => CompareTo(other),
        _ => throw new ArgumentException($"The argument must be a {nameof(GraphId)}.", nameof(obj)),
    };
