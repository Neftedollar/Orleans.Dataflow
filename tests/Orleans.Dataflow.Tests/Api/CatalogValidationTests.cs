    ...
    public void TheCatalogDeclaresExactlyTheLocalStages()
    {
        ...
        Assert.Equal(
            [
                ...
                LocalStage("group-by"),
                LocalStage("grouped"),
                LocalStage("grouped-weighted-within"),
                LocalStage("grouped-within"),
                LocalStage("ignore"),
    ...
    public void OnlyTheParameterizedStagesDeclareAParameterContractOfTheirOwnAndAValidator()
    {
        ...
        Assert.Equal(
            new Dictionary<string, string>(StringComparer.Ordinal)
            {
                ...
                ["group-by"] = "local-group-by-parameters",
                ["grouped"] = "local-count-parameters",
                ["grouped-weighted-within"] = "local-grouped-weighted-parameters",
                ["grouped-within"] = "local-grouped-within-parameters",
        ...
        foreach (StageSpecification specification in LocalStageCatalog.Instance.Specifications)
        {
            ...
            Assert.All(
                ...
                port =>
                {
                    ...
                    {
                        // An asynchronous fold declares the fold's own result contract because it is a
